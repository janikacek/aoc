...
public class compressed_file2 {
    ...
    public static void main(String[] args) {
        ...
        StringBuffer decompressedString = decompress(compressedString);
        System.out.println("decompressed string: " + decompressedString);
        System.out.println("length of decompressed string: " + decompressedString.length());
    }

    private static StringBuffer decompress(StringBuffer compressedString) {
        boolean skip = false;
        ...
        while (iterator < compressedString.length()) {
            ...
            // behind the marker - repetition
                ...
                if (signsToRepeate.charAt(0) == OPENING_SIGN) {
                    signsToRepeate = decompress(signsToRepeate);
                }
